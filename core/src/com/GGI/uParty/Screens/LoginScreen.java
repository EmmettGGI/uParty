...
public class LoginScreen implements Screen,InputProcessor{
	...
	private Rectangle emailBounds = new Rectangle(w/4, h/2, w/2, h/16);
	private Rectangle passBounds = new Rectangle(w/4,h/2-h/12,w/2,h/16);
	...
	public boolean touchUp(int screenX, int screenY, int pointer, int button) {
		...
		if(Intersector.overlaps(touch, passBounds)){selected = 2;Gdx.input.setOnscreenKeyboardVisible(true);}
		return true;
	}
